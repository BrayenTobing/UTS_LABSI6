...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$this->data['count_sewa']=$this->db->query("SELECT * FROM tbl_sewa WHERE status = 'Disewa'")->num_rows();
		$this->data['count_kembali']=$this->db->query("SELECT * FROM tbl_sewa WHERE status = 'Di Kembalikan'")->num_rows();
