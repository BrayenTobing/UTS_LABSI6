      ...
      <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <?php if($this->uri->uri_string() == 'data/kategori'){ echo 'active';}?>
				...
				<?php if($this->uri->uri_string() == 'data/alattambah'){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/alatdetail/'.$this->uri->segment('3')){ echo 'active';}?>
				<?php if($this->uri->uri_string() == 'data/alatedit/'.$this->uri->segment('3')){ echo 'active';}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                        ...
                        <a href="<?php echo base_url("data");?>" class="cursor">
                            <span class="fa fa-book"></span> Data Alat
            ...
            <li class="treeview 
                ...
                <?php if($this->uri->uri_string() == 'transaksi/sewa'){ echo 'active';}?>
                <?php if($this->uri->uri_string() == 'transaksi/detailsewa/'.$this->uri->segment('3')){ echo 'active';}?>
                <?php if($this->uri->uri_string() == 'transaksi/kembalisewa/'.$this->uri->segment('3')){ echo 'active';}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="<?php if($this->uri->uri_string() == 'transaksi'){ echo 'active';}?>
                        ...
                        <a href="<?php echo base_url("transaksi");?>" class="cursor">
                            <span class="fa fa-upload"></span> Sewa
			...
			<?php if($this->session->userdata('level') == 'Anggota'){?>
				<li class="<?php if($this->uri->uri_string() == 'transaksi'){ echo 'active';}?>">
					<a href="<?php echo base_url("transaksi");?>" class="cursor">
						<i class="fa fa-upload"></i> <span>Data Sewa </span>
					</a>
				</li>
				<li class="<?php if($this->uri->uri_string() == 'transaksi/kembali'){ echo 'active';}?>">
					<a href="<?php echo base_url("transaksi/kembali");?>" class="cursor">
				...
				<?php if($this->uri->uri_string() == 'data/alatdetail/'.$this->uri->segment('3')){ echo 'active';}?>">
					<a href="<?php echo base_url("data");?>" class="cursor">
						<i class="fa fa-search"></i>  <span>Cari Alat</span>
					</a>
				</li>
