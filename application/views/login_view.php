...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/alat-1.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: White;"><b>SISTEM INFORMASI<br/><b>ADVENTURE STORE</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; Sistem Informasi Adventure Store <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
